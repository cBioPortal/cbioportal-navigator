...
import { ComparisonSessionClient } from '../../infrastructure/api/comparisonSessionClient.js';
import {
...
} from './utils/groupBuilder.js';
import {
    buildComparisonUrl,
    type ComparisonTab,
} from './utils/buildComparisonUrl.js';
import {
    splitDataIntoQuartiles,
    type Quartile,
} from './utils/numericalBinning.js';
import { buildStudyUrl } from '../studyView/utils/buildStudyUrl.js';
import {
    createNavigationResponse,
    createErrorResponse,
} from '../shared/responses.js';
import { getConfig } from '../../infrastructure/utils/config.js';
...
export const navigateToGroupComparisonTool = {
    ...
    description: loadPrompt(
        'groupComparison/prompts/navigate_to_group_comparison.md'
    ),
    inputSchema: {
        studyIds: z
            .array(z.string())
